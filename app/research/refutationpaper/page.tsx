    ...
    return (
        <div>
            <div className="ml-2 mt-2 mb-10">
                ...
                <a href={`${basePath ? basePath : '' }/quigley_refutation.pdf`} target="_blank" className="text-xl outline rounded hover:bg-bg-light px-2">Download PDF</a>
            </div>
            <PDFViewer 
            file={`${basePath ? basePath : '' }/quigley_refutation.pdf`}
            />
        </div>
    );
}